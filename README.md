...
```bash
#海外
bash <(curl -Lsk https://raw.githubusercontent.com/742481030/ccaa/master/ccaa.sh)
#国内
bash <(curl -Lsk https://raw.githubusercontent.com/742481030/062+ccaa/master/ccaa.sh) cdn
```
